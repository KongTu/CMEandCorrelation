...
process.load("CMEandCorrelation.ThreePointCorrelator.threepointcorrelatornestedloop_cfi")

#define the cuts
process.ana.Nmin = 40
process.ana.Nmax = 1000

process.TFileService = cms.Service("TFileService",fileName = cms.string("test_gen_nested.root"))
