          ...
          if( deta == 0 ){
            for(int HF = 0; HF < HFside; HF++){
              for(int sign = 0; sign < 2; sign++){
                ...
                // double XY_real_temp = get2RealOverlap(Q1[ieta][sign][0], Q2[ieta][sign][0], Q1[ieta][sign][1], Q2[jeta][sign][1]);
                // double XY_imag_temp = get2ImagOverlap(Q1[ieta][sign][0], Q2[ieta][sign][0], Q1[ieta][sign][1], Q2[ieta][sign][1]);
                ...
                // XY_real[deta][sign][HF]->Fill( XY_real_temp/((Q1_count[ieta][sign]*Q1_count[ieta][sign] - Q2_count[ieta][sign]) ), (Q1_count[ieta][sign]*Q1_count[ieta][sign] - Q2_count[ieta][sign]) );
                // XY_imag[deta][sign][HF]->Fill( XY_imag_temp/((Q1_count[ieta][sign]*Q1_count[ieta][sign] - Q2_count[ieta][sign]) ), (Q1_count[ieta][sign]*Q1_count[ieta][sign] - Q2_count[ieta][sign]) );
...
ThreePointCorrelatorEtaGap::beginJob()
{
  ...
  edm::FileInPath fip1("CMEandCorrelation/ThreePointCorrelator/data/EPOS_eff_v9.root");  
  TFile f1(fip1.fullPath().c_str(),"READ");
