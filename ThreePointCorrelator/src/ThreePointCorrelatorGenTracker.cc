// -*- C++ -*-
//
// Package:    ThreePointCorrelatorGenTracker
// Class:      ThreePointCorrelatorGenTracker
// 
/**\class ThreePointCorrelatorGenTracker ThreePointCorrelatorGenTracker.cc CMEandCorrelation/ThreePointCorrelatorGenTracker/src/ThreePointCorrelatorGenTracker.cc
...
ThreePointCorrelatorGenTracker::ThreePointCorrelatorGenTracker(const edm::ParameterSet& iConfig)
...
ThreePointCorrelatorGenTracker::~ThreePointCorrelatorGenTracker()
{
...
void
ThreePointCorrelatorGenTracker::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  using namespace edm;
  using namespace std;
      ...
      for(int deta = 0; deta < NdEtaBins; deta++){
        if( deltaEta12 > dEtaBinsArray[deta] && deltaEta12 < dEtaBinsArray[deta+1] ){
          if( deta == 0 ){
              ...
              if( Q1_count[ieta][0] == 0.0 || Q1_count[ieta][1] == 0.0 || Qrp_count[keta] == 0.0 ) continue;
...
void 
ThreePointCorrelatorGenTracker::beginJob()
{
...
double 
ThreePointCorrelatorGenTracker::get3Real(double R1, double R2, double R3, double I1, double I2, double I3) 
{
...
double ThreePointCorrelatorGenTracker::get3RealOverlap(double R1, double R2, double R3, double I1, double I2, double I3, double N1, double N3){
...
double ThreePointCorrelatorGenTracker::get3Imag(double R1, double R2, double R3, double I1, double I2, double I3){
...
double ThreePointCorrelatorGenTracker::get3ImagOverlap(double R1, double R2, double R3, double I1, double I2, double I3, double N1, double N3){
...
double ThreePointCorrelatorGenTracker::get2Real( double R1, double R2, double I1, double I2){

      double real = R1*R2 - I1*I2;
      return real;

}
double ThreePointCorrelatorGenTracker::get2RealOverlap( double R1, double R2, double I1, double I2){

      double real = R1*R1 - I1*I1 - R2;
      return real;

}
double ThreePointCorrelatorGenTracker::get2Imag( double R1, double R2, double I1, double I2){

      double imag = R1*I2 + R2*I1;
      return imag;
}
double ThreePointCorrelatorGenTracker::get2ImagOverlap( double R1, double R2, double I1, double I2){
...
void 
ThreePointCorrelatorGenTracker::endJob() 
{
}

// ------------ method called when starting to processes a run  ------------
void 
ThreePointCorrelatorGenTracker::beginRun(edm::Run const&, edm::EventSetup const&)
{
}

// ------------ method called when ending the processing of a run  ------------
void 
ThreePointCorrelatorGenTracker::endRun(edm::Run const&, edm::EventSetup const&)
{
}

// ------------ method called when starting to processes a luminosity block  ------------
void 
ThreePointCorrelatorGenTracker::beginLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}

// ------------ method called when ending the processing of a luminosity block  ------------
void 
ThreePointCorrelatorGenTracker::endLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void
ThreePointCorrelatorGenTracker::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(ThreePointCorrelatorGenTracker);
